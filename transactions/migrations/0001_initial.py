    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracking_number', models.CharField(default='Z6RmOkmAXeCv', max_length=250)),
                ('number_of_items', models.IntegerField(null=True)),
                ('address', models.CharField(blank=True, max_length=250)),
                ('ordered', models.BooleanField(default=False)),
                ('delivered', models.BooleanField(default=False)),
                ('order_date', models.DateTimeField(default=datetime.datetime(2025, 1, 17, 7, 30, 0, 886251, tzinfo=datetime.timezone.utc))),
            ],
        ),
        migrations.CreateModel(
            name='Refund',
