    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracking_number', models.CharField(default='qSwOknIKlIrs', max_length=250)),
                ('number_of_items', models.IntegerField(null=True)),
                ('address', models.CharField(blank=True, max_length=250)),
                ('ordered', models.BooleanField(default=False)),
                ('delivered', models.BooleanField(default=False)),
                ('order_date', models.DateTimeField(default=datetime.datetime(2024, 9, 12, 17, 23, 51, 988646, tzinfo=utc))),
            ],
        ),
        migrations.CreateModel(
            name='Refund',
