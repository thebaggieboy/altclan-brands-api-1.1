# Generated by Django 4.2 on 2025-02-10 15:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracking_number', models.CharField(default='lRF1SipXRuyl', max_length=250)),
                ('number_of_items', models.IntegerField(null=True)),
                ('address', models.CharField(blank=True, max_length=250)),
                ('ordered', models.BooleanField(default=False)),
                ('delivered', models.BooleanField(default=False)),
                ('order_date', models.DateTimeField(default=datetime.datetime(2025, 2, 10, 15, 44, 3, 32175, tzinfo=datetime.timezone.utc))),
                ...
                ('delivery_type', models.CharField(blank=True, max_length=250)),
            ],
        ),
        migrations.CreateModel(
            name='Withdraw',
