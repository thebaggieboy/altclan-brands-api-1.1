    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracking_number', models.CharField(default='YZkAwt176e5m', max_length=250)),
                ('number_of_items', models.IntegerField(null=True)),
                ('address', models.CharField(blank=True, max_length=250)),
                ('ordered', models.BooleanField(default=False)),
                ('delivered', models.BooleanField(default=False)),
                ('order_date', models.DateTimeField(default=datetime.datetime(2024, 5, 3, 9, 55, 21, 985147, tzinfo=utc))),
            ],
        ),
        migrations.CreateModel(
            name='Refund',
