    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracking_number', models.CharField(default='C2UCIiAgWCnJ', max_length=250)),
                ('number_of_items', models.IntegerField(null=True)),
                ('address', models.CharField(blank=True, max_length=250)),
                ('ordered', models.BooleanField(default=False)),
                ('delivered', models.BooleanField(default=False)),
                ('order_date', models.DateTimeField(default=datetime.datetime(2024, 7, 27, 4, 52, 25, 861140, tzinfo=utc))),
            ],
        ),
        migrations.CreateModel(
            name='Refund',
