...
DATABASES = {
    'default': dj_database_url.config(default='postgres://postgresql://altclan_49s6_user:P089LrBXiuWfzJCFuPNVf5FaU0IMDdnT@dpg-cu50ar1u0jms73fcnne0-a.oregon-postgres.render.com/altclan_49s6')
}
