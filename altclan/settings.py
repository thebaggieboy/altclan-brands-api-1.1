...
DATABASES = {
    'default': dj_database_url.config(default='postgres://postgresql://altclan_6qyk_user:XsHecdmtjIbsbquGwETOQnRxxfM4nqgc@dpg-cuq7hfdumphs73edl3ug-a.oregon-postgres.render.com/altclan_6qyk')
}
