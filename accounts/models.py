...
class CustomUser(AbstractBaseUser):
    ...
    brand_name = models.CharField(max_length=250, null=True, blank=True, unique=True)
    ...
    account_status = models.CharField(max_length=250, choices=ACCOUNT_STATUS, default='active')
...
class Followers(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name='brand_followers', null=True, blank=True)
