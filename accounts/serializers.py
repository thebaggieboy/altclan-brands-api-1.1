...
class UserSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = CustomUser
        fields = ['id', 'slug',  'email', 'brand_name', 'brand_logo',  'brand_bio', 'followers', 'brand_type', 'brand_category',  'mobile_number', 'is_active', 'staff', 'admin', 'date_joined', 'account_status', 'billing_address', 'city', 'state', 'zip']
